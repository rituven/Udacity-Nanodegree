...
# find max and min exercised_stock_options and salary
eso = []
sal = []
for person in data_dict.keys():
    if data_dict[person]['exercised_stock_options'] != 'NaN' :
        eso.append(data_dict[person]['exercised_stock_options'])
    if data_dict[person]['salary'] != 'NaN' :
        sal.append(data_dict[person]['salary'])

print "Max and Min Exercised stock options are: ", max(eso), " , ", min(eso)
print "Max and Min salary are: ", max(sal), " , ", min(sal)
